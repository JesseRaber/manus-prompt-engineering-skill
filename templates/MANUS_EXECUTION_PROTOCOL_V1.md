...
## Prompt body minimums

After the envelope, include:

- one-sentence mission;
- task-specific starting gate(s);
- exact authorized scope and prohibited actions;
- evidence already established and prohibited inferences;
